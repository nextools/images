...
[![version](https://flat.badgen.net/badge/version/104.0a1/blue)](https://www.mozilla.org/en-US/firefox/releases/) [![size](https://flat.badgen.net/badge/size/154M/blue)](https://hub.docker.com/repository/docker/nextools/firefox/tags)
