...
[![version](https://flat.badgen.net/badge/version/105.0a1/blue)](https://www.mozilla.org/en-US/firefox/releases/) [![size](https://flat.badgen.net/badge/size/155M/blue)](https://hub.docker.com/repository/docker/nextools/firefox/tags)
